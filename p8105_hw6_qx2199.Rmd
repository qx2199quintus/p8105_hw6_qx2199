...
From the residual plot, we could see that the distribution for most of the residuals are not heavily skewed,especially when the predicted value is higher than 2000. However, when the predicted values are smaller than 2000, there are outliers--when the predicted value decrease, residuals increase.
